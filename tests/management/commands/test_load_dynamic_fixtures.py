...
class ManagementCommandLoadDynamicFixturesTestCase(MockTestCaseMixin, TestCase):
    ...
    def test_one_argument(self):
        ...
        self.mocked_fixtures_runner.assert_called_once_with()
        self.mocked_fixtures_runner.return_value.get_app_nodes.assert_called_once_with(app_label='my_app')
    ...
    def test_two_arguments(self):
        ...
        self.mocked_fixtures_runner.assert_called_once_with()
        self.mocked_fixtures_runner.return_value.get_fixture_node.assert_called_once_with(app_label='my_app',
                                                                                          fixture_prefix='0001')
